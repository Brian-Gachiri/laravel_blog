    ...
    <nav class="navbar navbar-expand-md bg-black navbar-dark">
        ...
        <div class="collapse navbar-collapse" id="main-navigation">
            ...
            <ul class="navbar-nav ml-auto navbar-dark">
                ...
                <li class="nav-item"><a class="nav-link" href="{{ route('contact', 1)}}">Contact</a></li>
                ...
                @guest
                            ...
                            @if (Route::has('register'))
                                <li class="nav-item">
                                    <a class="btn btn-orange rounded-pill px-4" href="{{ route('register') }}">{{ __('Register') }}</a>
                                </li>
                            @endif
                        @else
                            <li class="nav-item dropdown">
                                <a id="navbarDropdown" class="btn btn-orange rounded-pill px-4 dropdown-toggle" href="#" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false" v-pre>
                                    {{ Auth::user()->name }}
                                </a>
